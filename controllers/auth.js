...
async function login(req, res) {
  ...
  const result = { res: false, error: null, token: null, uid: null };
...
async function register(req, res) {
  ...
  const { login, email, _id } = newUser;
  const token = jwt.sign({ login, email, _id }, process.env.JWT_SECRET, {
    expiresIn: "7d",
  });
...
//     title: "zxc",
//     descr: "really good game really good game really good game really good game really good game really good gamereally good game really good game really good game",
//     score: 5,
//     date: new Date(),
//   });
